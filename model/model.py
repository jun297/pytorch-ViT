...
class Attention(nn.Module):
    ...
    qkv : nn.Linear
        Linear proejction for the query, key and value.
    
    proj : nn.Linear
        Linear mapping that takes in the concatenated output
        of all attention heads and maps it into a new space.
    
    atten_drop, proj_drop : nn.Dropout
        Dropout layers
    """
    def __init__(self, dim, n_heads=12, qkv_bias=True, attn_p=0., proj_p=0.):
        ...
        # not to feed extremely large values into softmax
        # which could lead into small gradinets
...
class Block(nn.Module):
    ...
    mlp : MLP
        MLP module.
    """
    def __init__(self, dim, n_heads, mlp_ratio=4.0, qkv_bias=True, attn_p=0., proj_p=0.):
        super().__init__()
        self.norm1 = nn.LayerNorm(dim, eps=1e-6) # to match the pretrained model
        self.attn = Attention(dim, n_heads, qkv_bias, attn_p, proj_p)
    ...
    def forward(self, x):
        ...
        # using two layernorm layer is important: 
        # they have seperate parameters.
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.pos_embed = nn.Parameter(
                ...
                # including position encoding for the class token
        )
